  ...
  <div class="nav_menu">
    <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
          <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url('assets/images/fajri.jpg') ?>" alt="">M.FAJRI
        ...
        <li role="presentation" class="dropdown">
          <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
            ...
            <span class="badge bg-red"><?php $nulltol = $nullex + $nullstock;
                                        if ($nulltol > 0) echo $nulltol ?></span>
          </a>
